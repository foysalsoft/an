...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update $tbl_name set S_IMG='$imgnewfile' where SLIDE_NO='$uid' ");
    if ($query) {
    	//Old pic
...
?>
		<p class="hint-text">Update slide image.</p>
        <input type="hidden" name="oldpic" value="<?php  echo $row['S_IMG'];?>">
