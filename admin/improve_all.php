    ...
    <nav class="navbar navbar-default" style="background-color: #fff; padding: 0.5vw  10vw;">
      <!--  <div class="container" style="background-color: #fff; border-radius: 5px;" > -->
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="http://localhost/rcl-web/">
                   <!-- <img src="../images/rcl_logo.png" class="img-fluid"  alt=""> -->
                   <h5 style="color: #111; font-family:'Times New Roman', Times, serif; font-weight: 900;">Our Project</h5>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="http://localhost/rcl-web/#page-top">Home</a>
                    </li>
                   <li>
                        <a class="page-scroll" href="http://localhost/rcl-web/#service">Career Build-up Tips</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="http://localhost/rcl-web/#contact">Contact</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
